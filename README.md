...
Para hacer la evaluación de la web, hemos usado la aplicación Gaze Recorder (https://gazerecorde.com/), y hemos obtenido unos heatmaps almacenados en nuestro git (https://github.com/AlvaroRodriguezGallardo/DIU/tree/master/P5/DIU3_LosEpsilonDelta_P5/heatmaps), que no exponemos aquí pues se trata de 36 imágenes y puede hacer innecesariamente largo este informe.

>>> Indica qué pretendes evaluar (de accesibilidad) sobre qué APP y qué resultados has obtenido 

**Diseño del experimento**

En primer lugar hemos seleccionado 6 páginas de las subidas por el grupo DIU1.02Amine. Dichas páginas son: Inicio, Quiénes somos, Galería, Reserva, Contacto y FAQ. Con el objetivo de hacer un seguimiento de las partes más destacadas del proyecto, hemos identificado las siguientes áreas de interés que el usuario debe reconocer:
  - Icono de idioma
...
**Consclusiones y posibles mejoras al diseño**
...
En general, las prácticas han consistido en la evaluación de una página web (sobre arte nazarí), la propuesta de un posible diseño y la evaluación del diseño de un compañero. Ciertamente el proceso puede parecer a veces tedioso, aunque los resultados obtenidos tras usar la metodología UX son bastantes satisfactorios, si bien el objetivo es atraer al usuario (o incluso cliente) al uso de nuestra página web. Finalmente, consideramos bastante interesante cómo en función de los elementos que elijamos, como un mero color, puedan significar una diferencia significativa en lo que respecta a si conseguimos (como empresa) mayor o menor número de ganancias.
